...
sudo pacman -S bc rsync termite thunar dmenu mlocate bash-completion pkgstats zip unzip unrar p7zip lzop cpio alsa-utils alsa-plugins pulseaudio pulseaudio-alsa ntfs-3g dosfstools exfat-utils f2fs-tools fuse fuse-exfat autofs mtpfs 
