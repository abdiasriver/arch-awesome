...
## AWESOME
sudo pacman -Sy
sudo pacman -S awesome variety compton colordiff lxappearance neofetch epdfview nitrogen termite colordiff git xdg-user-dirs-gtk --noconfirm --needed
...
cp -r dotfiles/.bashrc dotfiles/.dircolors dotfiles/.dircolors_256 dotfiles/.nanorc dotfiles/.yaourtrc ~/
rm -fr dotfiles
