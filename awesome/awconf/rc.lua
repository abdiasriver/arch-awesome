...
awful.util.tagnames = { "www ", "docs ", "Term ", "⠻Video ", "" }
...
globalkeys = my_table.join(
    ...
    {description = "show dmenu", group = "super"}),


    -- super + ... function keys
    awful.key({ modkey }, "c", function () awful.util.spawn( browser1 ) end,
  ...
  awful.key({ modkey }, "x",  function () awful.util.spawn( "oblogout" ) end,
    ...
    -- screenshots
    awful.key({ }, "Print", function () awful.util.spawn("scrot 'Pic-%Y-%m-%d-%s_screenshot_$wx$h.jpg' -e 'mv $f $$(xdg-user-dir PICTURES)'") end,
