...
trizen -S f2fs-tools file-roller --noconfirm --needed --noedit

trizen -S git gnome-disk-utility gst-libav gst-plugins-bad gst-plugins-ugly gtk-engine-murrine gtk2-perl gvfs gvfs-afc gvfs-goa gvfs-google gvfs-mtp --noconfirm --needed --noedit

trizen -S hardinfo hddtemp htop --noconfirm --needed --noedit

trizen -S intel-tbb intel-ucode inxi ipw2100-fw ipw2200-fw --noconfirm --needed --noedit
...
trizen -S tamsyn-font termite thunar thunar-archive-plugin thunar-volman transmission-gtk ttf-bitstream-vera ttf-dejavu ttf-droid ttf-font-awesome ttf-inconsolata ttf-liberation ttf-mac-fonts ttf-roboto ttf-ubuntu-font-family --noconfirm --needed --noedit
